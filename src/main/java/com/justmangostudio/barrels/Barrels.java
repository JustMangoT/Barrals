...
import com.justmangostudio.barrels.items.BarrelModule;
import com.justmangostudio.barrels.items.IDCard;
import com.justmangostudio.barrels.listeners.DisplayListener;
import com.justmangostudio.barrels.listeners.WorldListener;
...
public class Barrels extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        //Updater updater = new GitHubBuildsUpdater(this, getFile(), "JustMangoT/Barrels/master");;
    ...
    public String getBugTrackerURL() {
        return "https://github.com/JustMangoT/Barrels/issues";
    }
